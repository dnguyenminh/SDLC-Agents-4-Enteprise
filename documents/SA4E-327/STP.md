...
## 1. Introduction
Purpose: Test task decomposition and Map-Reduce for large repo queries.
...
## 3. Test Scope
In Scope: Task decomposition, Map-Reduce summarization, Synthesis
Out of Scope: Full repo re-indexing
